...
"""
        ...
        assert (
            "executive summary" in result["company_overview"].lower()
            or "This is the executive summary" in result["company_overview"]
        )
    ...
    def test_map_header_variations(self):
        ...
        for header, expected_key in test_cases:
            ...
            assert result == expected_key, (
                f"Header '{header}' should map to '{expected_key}', got '{result}'"
            )
