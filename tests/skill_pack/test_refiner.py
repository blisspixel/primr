...
def test_actionable_findings_includes_too_short_body():
    ...
    actionable = _actionable_findings(skill, "sam-plus-consultant")
...
def test_actionable_findings_skips_healthy_skill():
    ...
    assert _actionable_findings(skill, "sam-plus-consultant") == []
...
def test_refine_role_expands_thin_body():
    ...
    assert _actionable_findings(role.skills[0], "sam-plus-consultant") == []
...
def test_auto_resolve_rescopes_second_skill_and_pops_entry():
    ...
    coherence = {
        "semantic_overlaps": [
            {
                "skill_a": "sam-plus-consultant/producing-cost-savings-reports",
                "skill_b": "sam-plus-consultant/reporting-managed-services-margins",
