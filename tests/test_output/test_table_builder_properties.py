...
class TestTableStylingConsistency:
    ...
    **Validates: Requirements 5.5**
    ...
    @given(
        ...
        revenue=st.text(
            min_size=1, max_size=20, alphabet=st.characters(whitelist_categories=["N", "S"])
        ),
    )
    def test_snapshot_table_has_consistent_structure(self, company_name, industry, revenue):
        ...
        snapshot = CompanySnapshot(
            company_name=company_name, industry=industry, revenue=revenue if revenue else None
        )
