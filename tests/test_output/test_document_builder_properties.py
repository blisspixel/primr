...
from primr.output.chapter_config import CHAPTER_CONFIG, get_section_number, get_chapter_for_section
...
class TestChapterGrouping:
    ...
    **Validates: Requirements 1.4**
    ...
    def test_get_section_number_returns_valid_format(self, section_key):
        ...
        assert parts[0].isdigit(), f"Chapter number should be digit"
        assert parts[1].isdigit(), f"Section number should be digit"
