...
from primr.recon.fingerprints import _validate_regex
...
class TestUUIDValidation:
    ...
    async def test_path_traversal_rejected(self):
        from primr.recon.sources.azure_metadata import AzureMetadataSource
    ...
    async def test_valid_uuid_accepted(self):
        ...
        with patch("primr.recon.sources.azure_metadata.http_client", fake_http_client):
