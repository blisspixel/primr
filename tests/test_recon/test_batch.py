...
import primr.recon.cli
from primr.recon.cli import _preprocess_args, app
...
RESOLVE_PATH = "primr.recon.resolver.resolve_tenant"
...
class TestPreprocessArgs:
    ...
    def _reset(self):
        ...
        primr.recon.cli._preprocessed = False
