...
from primr.recon.models import (
    ReconLookupError,
    SourceResult,
)
from primr.recon.resolver import SourcePool, default_pool, resolve_tenant
...
class TestDefaultPool:
    ...
    def test_default_pool_order(self) -> None:
        ...
        assert names == ["oidc_discovery", "user_realm", "dns_records"]
...
class TestPropertyUnparseableOIDCFallback:
    ...
    **Validates: Requirements 2.5, 6.2**
    ...
    async def test_unparseable_oidc_triggers_fallback(self, bad_json: dict) -> None:
        ...
        from primr.recon.sources.oidc import parse_tenant_info_from_oidc
