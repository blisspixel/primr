...
# Fast mode (~$0.50, ~20 min, uses Grok 4.1 — requires XAI_API_KEY)
primr "Company" https://example.com --fast

# Fast + multi-vendor AI strategy (~$0.55, 20-28 min)
