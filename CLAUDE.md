...
# Standard run (~$0.55, ~35-45 min — auto-uses Grok 4.1 when XAI_API_KEY set)
...
*Last updated: 2026-03-23 | Primr v1.16.0 | Agentic Architecture v1.0 | A2A Protocol v1.0*
