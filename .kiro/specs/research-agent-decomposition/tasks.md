...
- [ ] 1. Update config module for lazy validation
...
- [ ] 3. Create workspace.py module
  - [ ] 3.1 Implement workspace dataclasses and constants
...
- [ ] 5. Create structured_research.py module
  ...
  - [ ] 5.4 Extract section research functions
...
- [ ] 8. Create ai_strategy.py module
  - [ ] 8.1 Implement AI strategy dataclasses and enums
    ...
    - _Requirements: 1.4_
  - [ ] 8.2 Extract AI strategy generation functions
  ...
  - [ ] 8.3 Refactor to async and decompose
  ...
  - [ ] 8.4 Write unit tests for AI strategy
    - Test CloudVendor enum values and display names
    - Test config validation
    - Test prompt building
    - _Requirements: 1.4, 2.3_

- [ ] 9. Create deep_research_runner.py module
  - [ ] 9.1 Implement deep research dataclasses and enums
    ...
    - _Requirements: 1.3_
  - [ ] 9.2 Extract preflight validation
...
- [ ] 12. Refactor research_agent.py to orchestration hub
  - [ ] 12.1 Implement orchestration dataclasses
    - Create `ResearchConfig` frozen dataclass
    - Create `ResearchResult` dataclass
    - Create `ResearchRunner` protocol
    - _Requirements: 1.1_
  - [ ] 12.2 Refactor perform_research to delegate
  ...
  - [ ] 12.3 Add backward compatible re-exports
  ...
  - [ ] 12.4 Write property test for module import compatibility
...
- [ ] 14. Write property tests for module independence
  - [ ] 14.1 Write property test for function size constraint
    - **Property 3: Function size constraint**
    - **Validates: Requirements 2.5**
  - [ ] 14.2 Write property test for module independence
