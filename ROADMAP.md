...
- **Secret / log redaction**: guarantee usage records and structured logs never serialize API keys or secret-bearing prompt content; add a redaction pass + a property test asserting no key-shaped strings reach logs/artifacts.
