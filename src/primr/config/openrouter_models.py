...
def build_openrouter_models(
    ...
    return (
        ...
        # Zhipu GLM modern additions (eval candidates)
        model_config_type(
            name="z-ai/glm-5.3",
            display_name="OpenRouter: GLM 5.3",
            provider="openrouter",
            cost_per_1m_input_tokens=1.40,
        ...
        model_config_type(
            ...
            display_name="OpenRouter: GLM 5.3 Flash",
            provider="openrouter",
            ...
            supports_tools=True,
            supports_multimodal=True,
            cost_per_1m_input_tokens_cached=0.009,
        ),
        # Qwen modern additions (eval candidates)
        model_config_type(
            name="qwen/qwen3.8-flash",
            display_name="OpenRouter: Qwen 3.8 Flash",
            provider="openrouter",
            cost_per_1m_input_tokens=0.15,
            cost_per_1m_output_tokens=0.47,
            max_input_tokens=1_000_000,
            max_output_tokens=65_536,
            supports_thinking=False,
            supports_tools=True,
            supports_multimodal=True,
            cost_per_1m_input_tokens_cached=0.015,
        ),
        model_config_type(
            name="qwen/qwen3.8-max-0902",
            display_name="OpenRouter: Qwen 3.8 Max 0902",
            provider="openrouter",
        ...
        # DeepSeek modern additions (eval candidates)
        model_config_type(
            name="deepseek/deepseek-v4.1-flash",
            display_name="OpenRouter: DeepSeek V4.1 Flash",
            provider="openrouter",
            cost_per_1m_input_tokens=0.15,
        ...
        model_config_type(
            ...
            display_name="OpenRouter: DeepSeek V4 Pro 0813",
            provider="openrouter",
            cost_per_1m_input_tokens=0.579,
            cost_per_1m_output_tokens=1.738,
            max_input_tokens=1_048_576,
            max_output_tokens=65_536,
            supports_thinking=True,
            supports_tools=True,
            supports_multimodal=False,
            cost_per_1m_input_tokens_cached=0.058,
        ),
        # OpenAI modern additions (eval candidates)
        model_config_type(
            name="openai/gpt-5.6-luna",
            display_name="OpenRouter: GPT-5.6 Luna",
            provider="openrouter",
            cost_per_1m_input_tokens=0.20,
