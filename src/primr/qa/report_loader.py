...
class ReportLoader:
    ...
    def find_latest_report(self, company_name: str) -> Path | None:
        """
    ...
    def load_report_from_path(self, report_path: Path) -> ReportContent | None:
        """
    ...
    def load_report_content(self, company_name: str) -> ReportContent | None:
        """
