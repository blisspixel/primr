...
class PrimrTokenVerifier:
    ...
    def _verify_jwt(self, token: str) -> Optional[AccessToken]:
        """
        Verify a JWT token.
    ...
    def _get_cached(self, token: str) -> Optional[AccessToken]:
...
class AuthContext:
    ...
    def __init__(self, access_token: Optional[AccessToken] = None):
        """
    ...
    def can_cancel_job(self, job_owner_id: Optional[str]) -> bool:
        """
