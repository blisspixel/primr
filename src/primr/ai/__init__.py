...
_EXPORTS: dict[str, tuple[str, str]] = {
    ...
    "BillingMode": ("primr.ai.capability_routing", "BillingMode"),
    "InferenceProfile": ("primr.ai.capability_routing", "InferenceProfile"),
    "LatencyClass": ("primr.ai.capability_routing", "LatencyClass"),
    "ReasoningDepth": ("primr.ai.capability_routing", "ReasoningDepth"),
    "RejectedCandidate": ("primr.ai.capability_routing", "RejectedCandidate"),
    "RouteCandidate": ("primr.ai.capability_routing", "RouteCandidate"),
    "RoutePlan": ("primr.ai.capability_routing", "RoutePlan"),
    "RoutingPolicy": ("primr.ai.capability_routing", "RoutingPolicy"),
