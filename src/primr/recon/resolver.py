...
import httpx  # noqa: TC002 — used at runtime in dict annotation and function params

from primr.recon.merger import merge_results
from primr.recon.models import ReconLookupError, SourceResult, TenantInfo
from primr.recon.sources.base import LookupSource  # noqa: TC001 — used at runtime in SourcePool
...
def default_pool() -> SourcePool:
    ...
    from primr.recon.sources.oidc import OIDCSource
    from primr.recon.sources.userrealm import UserRealmSource
