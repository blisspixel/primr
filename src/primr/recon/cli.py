...
from primr.recon.formatter import get_console
...
def main(
    ...
    [dim]Usage:[/dim]
      primr recon pepsi.com
      primr recon microsoft.com --services
      primr recon tesla.com --full
      primr recon softchoice.com --md > report.md
      primr recon batch domains.txt --json
      primr recon doctor
    """
...
async def _lookup(
    ...
    from primr.recon.formatter import (
        format_tenant_json,
