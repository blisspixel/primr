...
async def lookup_tenant(
    ...
    Returns detected SaaS services (140+ fingerprints), email security posture,
...
async def reload_data() -> str:
    ...
    the new definitions.
    """
    from primr.recon.fingerprints import reload_fingerprints
    from primr.recon.signals import reload_signals
    ...
    from primr.recon.signals import load_signals
