...
def fetch_sitemap_links(
    base_url: str,
    config: SitemapConfig | None = None,
...
def verify_urls_exist(
    ...
    def check_url(link: DiscoveredLink) -> DiscoveredLink | None:
...
def discover_links(
    base_url: str,
    sitemap_config: SitemapConfig | None = None,
    rate_limiter: RateLimiter | None = None,
    ...
    logger.debug("Extracting links from homepage")
