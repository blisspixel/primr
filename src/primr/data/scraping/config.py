...
DEFAULT_TIMEOUT_REQUESTS = 10
DEFAULT_TIMEOUT_HTTPX = 10
DEFAULT_TIMEOUT_CURL_CFFI = 15
DEFAULT_TIMEOUT_DRISSION = 20
DEFAULT_TIMEOUT_PLAYWRIGHT = 20  # seconds (converted to ms in tier)
DEFAULT_TIMEOUT_DRISSION_STEALTH = 30
DEFAULT_TIMEOUT_PLAYWRIGHT_AGGRESSIVE = 30
DEFAULT_TIMEOUT_VISION = 45
