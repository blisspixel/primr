...
- **T8 Stages 1-3** are shipped for MCP tool dispatch and resource reads:
  ...
  raw resource bodies, or raw caller ids. Residual risk remains around A2A
  parity and any
