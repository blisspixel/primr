...
- **T8 Stages 1-3** are shipped for MCP tool dispatch and resource reads:
  ...
  outcome, and job id when present. Residual risk remains around A2A
  approval, budget, and compact resource parity and any
