...
- **T8 Stages 1-3** are shipped for MCP tool dispatch: per-tool scopes,
  ...
  first three job-scoped artifact-resource slices are also shipped:
  ...
  company URLs, approval tokens, manifest artifact lists, or full manifest content. All
