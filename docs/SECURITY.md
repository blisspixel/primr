...
- **T8 Stages 1-3** are shipped for MCP tool dispatch: per-tool scopes,
  ...
  behind the same response as missing jobs. Residual risk
  remains around A2A parity and any
