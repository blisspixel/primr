...
Breakdown documents for the [Release Dependency Map](https://github.com/blisspixel/primr/blob/main/ROADMAP.md#release-dependency-map)
...
| [provider-expansion.md](provider-expansion.md) | OpenAI/Anthropic recipes, governed OpenRouter preview, Bedrock/Foundry gateways, and $0 local profile (provider catalog refreshed September 2026) | 1.x Phase A; 2.0 Phases B/C |
...
| [grok-default-routing.md](grok-default-routing.md) | Why hybrid stays on Grok 4.3; MAX uses 4.5; eval gate before any default promotion | 1.x model routing |
