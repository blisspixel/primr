...
| [2.0-agent-control-plane.md](2.0-agent-control-plane.md) | Per-tool authz, approval tokens, audit log, job-scoped artifact metadata and QA summary resources; next slice is source/trace/usage resources and A2A parity | 2.0 |
