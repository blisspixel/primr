...
| [2.0-agent-control-plane.md](2.0-agent-control-plane.md) | Per-tool authz, approval tokens, tool-call and resource-read audit log, job-scoped artifact metadata, QA summary, usage/cost summary, source appendix summary, scrape trace summary, verification summary, calibration summary resources, and A2A skill-scope parity; next slice is A2A approval/audit/resource parity | 2.0 |
