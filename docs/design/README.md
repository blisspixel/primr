...
| [2.0-backend-freedom.md](2.0-backend-freedom.md) | Capability routing + local/hybrid inference; first routed utility stage and route usage metadata shipped for `fast.source_relevance`, next slice is the next utility stage | 2.0 |
