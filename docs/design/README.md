...
| [2.0-backend-freedom.md](2.0-backend-freedom.md) | Capability routing + local/hybrid inference; routed utility-stage metadata shipped for `fast.scrape_summary` and `fast.source_relevance`, next slice is `fast.hiring_signals` | 2.0 |
