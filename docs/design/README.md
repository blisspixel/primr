...
| [2.0-agent-control-plane.md](2.0-agent-control-plane.md) | Per-tool authz, approval tokens, audit log, job-scoped artifact metadata, QA summary, usage/cost summary, source appendix summary, and scrape trace summary resources; next slice is verification/calibration resources and A2A parity | 2.0 |
