...
| [2.0-agent-control-plane.md](2.0-agent-control-plane.md) | Per-tool authz, approval tokens, audit log, first job-scoped artifact metadata resource; next slice is richer resources and A2A parity | 2.0 |
