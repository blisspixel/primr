...
| [2.0-agent-control-plane.md](2.0-agent-control-plane.md) | Per-tool authz, approval tokens, audit log, job-scoped artifact metadata, QA summary, usage/cost summary, source appendix summary, scrape trace summary, verification summary, and calibration summary resources; next slice is A2A parity and resource-read auditing | 2.0 |
