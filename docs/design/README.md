...
| [2.0-backend-freedom.md](2.0-backend-freedom.md) | Capability routing + local/hybrid inference; immediate slice is one routed utility stage after provider cleanup and cost-estimate honesty | 2.0 |
